...
//    }
    ...
    public void init(String role, PRObjectGraph graph, Map<String, Set<ObjId>> secondaryIndex) {
        this.role = role;
        this.graph = graph;
...
//                        ret.add(stockDistrictObjId);
                    ...
                    case READ: {
                        ObjId objId = secondaryIndex.get((String) params.get("key")).iterator().next();
                        ret.add(objId);
                        break;
                    }
                }
...
//                                    System.out.println("found orderLiness" + orderLines);
                            ...
                            if (!found)
                                System.out.println("Found no new ordor for w=" + terminalWarehouseID + ":d=" + districtID);
                        }
...
//                        ret.add(stockDistrictObjId);
                ...
                System.out.println("ERROR: " + e.getMessage() + " command " + command.toFullString());
                e.printStackTrace();
//                throw e;
            }
        } else {
